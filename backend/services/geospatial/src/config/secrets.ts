 ...
 *
 * Este servicio hoy no maneja secretos (solo INTAKE_SERVICE_URL, con
 * fallback local); igual sigue el mismo patrón que los demás para que la
 * arquitectura sea uniforme y quede lista si en el futuro necesita acceso
 * directo a Supabase/PostGIS.
 */
